...
public abstract class AbstractRepository<T> implements Repository<T> {
    ...
    public List<T> findAll2() throws RepositoryException {
        Builder builder = BuildFactory.create(getTableName());
        //String query = GET_ALL_QUERY + getTableName() + " WHERE id=1";
        String query = "select * from orders, persons where orders.personId=persons.id";
